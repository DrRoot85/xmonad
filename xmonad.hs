...
myStartupHook = do
  ...
  spawnOnce "nm-applet"
  spawn "clipmenud "
  spawn "/usr/bin/pipewire "
  spawn "/usr/bin/pipewire-pulse "
  spawn "/usr/bin/wireplumber "
  spawnOnce "volumeicon"
  spawnOnce "dunst" -- Set Dunst System Notify
  spawn "setxkbmap -model apple_laptop -layout us,ara -variant mac,mac -option grp:alt_shift_toggle"
...
myKeys c =
  ...
  ^++^ subKeys "ClipMenu"
  [
    ("M-C-c", addName "ClipMenu "    $ spawn "clipmenu -c -l 15 -p 'ClipBoard: ' " )
  ]

  -- Theme Changer
  ^++^ subKeys "ThemeChanger Pywal"
  [
    ("M-C-t", addName "ThemeChanger "    $ spawn "themechanger" )
  ]
  ...
  , ("<XF86AudioMute>", addName "Toggle audio mute"   $ spawn "pamixer --toggle-mute ")
  , ("<XF86AudioLowerVolume>", addName "Lower vol"    $ spawn "pamixer -d 5 --unmute")
  , ("<XF86AudioRaiseVolume>", addName "Raise vol"    $ spawn "pamixer --allow-boost -i 5 --unmute")
  ...
  , ("<XF86KbdBrightnessUp>", addName "Kbd Brightness Up"    $ spawn "xbacklight -ctrl smc::kbd_backlight -inc 5")
  , ("<XF86KbdBrightnessDown>", addName "Kbd Brightness Down"    $ spawn "xbacklight -ctrl smc::kbd_backlight -dec 5")
  ...
  -- , ("<XF86LaunchA>", addName "Take screenshot (dmscripts)" $ spawn "dm-maim")
  -- , ("<XF86LaunchB>", addName "Take screenshot (dmscripts)" $ spawn "dm-maim")
  ]
